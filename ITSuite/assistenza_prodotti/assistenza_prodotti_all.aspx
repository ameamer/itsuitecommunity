...
<%@ Page Language="VB" AspCompat="true" MasterPageFile="../MasterPage.master" AutoEventWireup="false" CodeFile="assistenza_prodotti_all.aspx.vb" Inherits="assistenza_prodotti_assistenza_prodotti_all" %>
...
<div class="HorizontalTopMenuContainer">
        <div class="HorizontalTopMenuItemSelected" style="border-left: 1px solid lightgray;" >
            <%=globals.ResourceHelper.GetString("String91")%>
        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderSubTitle" Runat="Server">
    <%=globals.ResourceHelper.GetString("String733")%>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderCentral" Runat="Server">
     <form id="form1" runat="server">
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="ID" DataSourceID="TutteAssSql">
        ...
        <asp:SqlDataSource ID="TutteAssSql" runat="server" ProviderName="System.Data.SqlClient">
        </asp:SqlDataSource>
    </form>
</asp:Content>