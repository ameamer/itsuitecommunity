...
Partial Class gestione_altro_hardware_gestione_altrohw_lista
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        Me.Title = globals.ResourceHelper.GetString("String183") & " | ITSuite by Ame Amer (admin@ameamer.com)"
        ...
        ' Imposto comandi sql
        SqlAltroHwLista.ConnectionString = ITSuite_Database.DBConnectionStrings.SQLSrvConnectionString()
        SqlAltroHwLista.SelectCommand = ITSuite_Database.DBConnectionStrings.SQLCommands.SQLAltroHwListaGenerale()

        Dim t As String = Request.QueryString("t")
        Select Case t
            Case "del_ok"
                ErrorMsg.Text = globals.ResourceHelper.GetString("String161")
