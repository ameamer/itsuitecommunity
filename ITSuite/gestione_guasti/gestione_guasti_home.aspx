...
<%@ Page Language="VB" MasterPageFile="../MasterPage.master" AutoEventWireup="false" CodeFile="gestione_guasti_home.aspx.vb" Inherits="gestione_guasti_gestione_guasti_home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" Runat="Server">
    <div class="HorizontalTopMenuContainer">
        ...
        <div class="HorizontalTopMenuItemSelected" style="padding-left: 10px;">
            <%=globals.ResourceHelper.GetString("String19") %>
        </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderCentral" runat="Server">
    <form runat="server">
        ...
        <asp:UpdatePanel runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:ListView ID="ListViewGuasti" runat="server" DataKeyNames="ID" DataSourceID="GuastiApertiSource">
                ...
                <asp:SqlDataSource ID="GuastiApertiSource" runat="server" ProviderName="System.Data.SqlClient">
                    <SelectParameters>
