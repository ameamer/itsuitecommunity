...
<%@ Page Language="VB" MasterPageFile="../MasterPage.master" AutoEventWireup="false" CodeFile="gestione_guasti_inattesa.aspx.vb" Inherits="gestione_guasti_gestione_guasti_inattesa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" Runat="Server">
    <div class="HorizontalTopMenuContainer">
           ...
           <%=globals.ResourceHelper.GetString("String20") %>
        </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderCentral" runat="Server">
    <form runat="server">
        ...
        <asp:UpdatePanel runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:ListView ID="ListViewGuasti" runat="server" DataKeyNames="ID" DataSourceID="GuastiAttesaSource">
                ...
                <asp:SqlDataSource ID="GuastiAttesaSource" runat="server" ProviderName="System.Data.SqlClient">
                    <SelectParameters>
