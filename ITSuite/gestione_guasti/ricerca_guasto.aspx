...
<%@ Page Language="VB" MasterPageFile="../MasterPage.master" AutoEventWireup="false" CodeFile="ricerca_guasto.aspx.vb" Inherits="gestione_utenti_ricerca_guasto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" Runat="Server">
     <%=globals.ResourceHelper.GetString("String87") %>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderSubTitle" Runat="Server">
     <%=globals.ResourceHelper.GetString("String248") %>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderCentral" runat="Server">
    ...
    <form name="SearchTicketForm" method="post" action="risultati_ricerca.aspx">
        <div class="contsearchscreen">
            <input name="schterm" type="text" class="search_box_long" placeholder="Inserisci i termini di ricerca..." style="border: 1px solid black;" />
            <select name="typsearch" class="select-order-searcher">
                <option value="only"><%=globals.ResourceHelper.GetString("String249") %></option>
