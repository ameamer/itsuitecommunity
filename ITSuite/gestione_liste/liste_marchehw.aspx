...
<%@ Page Language="VB" MasterPageFile="../MasterPage.master" AutoEventWireup="false" CodeFile="liste_marchehw.aspx.vb" Inherits="gestione_liste_liste_marchehw" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" Runat="Server">
    <%= globals.ResourceHelper.GetString("String323") %>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderSubTitle" Runat="Server">
    <%= globals.ResourceHelper.GetString("String324") %>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderCentral" runat="Server">
    <form id="form1" runat="server">
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="ID" DataSourceID="MarchehwDataSource" InsertItemPosition="LastItem" OnItemInserting="ListView1_ItemInserting">
            <AlternatingItemTemplate>
                <tr class="tr-alt-list">
                    ...
                    <td>
                        <asp:Label ID="repartiLabel" runat="server" Text='<%# Eval("marche_hw") %>' />
                    </td>
                </tr>
            </AlternatingItemTemplate>
            <EditItemTemplate>
                <tr class="tr-list-edit">
                    ...
                    <td>
                        <asp:TextBox ID="repartiTextBox" runat="server" Text='<%# Bind("marche_hw") %>' Style="width: 70%;" />
                    </td>
                </tr>
            </EditItemTemplate>
            <EmptyDataTemplate>
            ...
            <table style="border: 0px solid green; width: 100%; margin-top: 20px;">
                <tr style="">
                    <td style="width: 100%;">
                        <asp:TextBox ID="repartiTextBox" placeholder='<%# globals.ResourceHelper.GetString("String325") %>' runat="server" Text='<%# Bind("marche_hw") %>' Style="width: 100%; background-color: #a6ffa6; border: 1px solid black; box-sizing: border-box;" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 100%">
        ...
        <asp:SqlDataSource ID="MarchehwDataSource" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\itstdb.mdf;Integrated Security=True" DeleteCommand="DELETE FROM [marche_hw] WHERE [Id] = @Id" InsertCommand="INSERT INTO [marche_hw] ([marche_hw]) VALUES (@marche_hw)" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [marche_hw]" UpdateCommand="UPDATE [marche_hw] SET [marche_hw] = @marche_hw WHERE [Id] = @Id">
            <DeleteParameters>
                <asp:Parameter Name="Id" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
                <asp:Parameter Name="marche_hw" Type="String" />
            </InsertParameters>
            <UpdateParameters>
                <asp:Parameter Name="marche_hw" Type="String" />
            </UpdateParameters>
