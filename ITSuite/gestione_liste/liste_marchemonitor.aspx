...
<%@ Page Language="VB" MasterPageFile="../MasterPage.master" AutoEventWireup="false" CodeFile="liste_marchemonitor.aspx.vb" Inherits="gestione_liste_liste_marchemonitor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" Runat="Server">
    <%= globals.ResourceHelper.GetString("String326") %>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderSubTitle" Runat="Server">
    <%= globals.ResourceHelper.GetString("String327") %>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderCentral" runat="Server">
    <form id="form1" runat="server">
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="ID" DataSourceID="MarchemonitorDataSource" InsertItemPosition="LastItem" OnItemInserting="ListView1_ItemInserting">
            <AlternatingItemTemplate>
                <tr class="tr-alt-list">
                    ...
                    <td>
                        <asp:Label ID="repartiLabel" runat="server" Text='<%# Eval("marche_monitor") %>' />
                    </td>
                </tr>
            </AlternatingItemTemplate>
            <EditItemTemplate>
                <tr class="tr-list-edit">
                    ...
                    <td>
                        <asp:TextBox ID="repartiTextBox" runat="server" Text='<%# Bind("marche_monitor") %>' Style="width: 70%;" />
                    </td>
                </tr>
            </EditItemTemplate>
            <EmptyDataTemplate>
            ...
            <table style="border: 0px solid green; width: 100%; margin-top: 20px;">
                <tr style="">
                    <td style="width: 100%;">
                        <asp:TextBox ID="repartiTextBox" placeholder='<%# globals.ResourceHelper.GetString("String328") %>' runat="server" Text='<%# Bind("marche_monitor") %>' Style="width: 100%; background-color: #a6ffa6; border: 1px solid black; box-sizing: border-box;" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 100%">
        ...
        <asp:SqlDataSource ID="MarchemonitorDataSource" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\itstdb.mdf;Integrated Security=True" DeleteCommand="DELETE FROM [marchemonitor_tab] WHERE [Id] = @Id" InsertCommand="INSERT INTO [marchemonitor_tab] ([marche_monitor]) VALUES (@marche_monitor)" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [marchemonitor_tab]" UpdateCommand="UPDATE [marchemonitor_tab] SET [marche_monitor] = @marche_monitor WHERE [Id] = @Id">
            <DeleteParameters>
                <asp:Parameter Name="Id" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
                <asp:Parameter Name="marche_monitor" Type="String" />
            </InsertParameters>
            <UpdateParameters>
                <asp:Parameter Name="marche_monitor" Type="String" />
            </UpdateParameters>
