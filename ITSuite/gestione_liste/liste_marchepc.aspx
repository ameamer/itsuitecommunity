...
<%@ Page Language="VB" MasterPageFile="../MasterPage.master" AutoEventWireup="false" CodeFile="liste_marchepc.aspx.vb" Inherits="gestione_liste_liste_marchepc" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" Runat="Server">
    <%= globals.ResourceHelper.GetString("String329") %>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderSubTitle" Runat="Server">
    <%= globals.ResourceHelper.GetString("String330") %>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderCentral" runat="Server">
    <form id="form1" runat="server">
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="ID" DataSourceID="MarchepcDataSource" InsertItemPosition="LastItem" OnItemInserting="ListView1_ItemInserting">
            <AlternatingItemTemplate>
                <tr class="tr-alt-list">
                    ...
                    <td>
                        <asp:Label ID="repartiLabel" runat="server" Text='<%# Eval("marche_pc") %>' />
                    </td>
                </tr>
            </AlternatingItemTemplate>
            <EditItemTemplate>
                <tr class="tr-list-edit">
                    ...
                    <td>
                        <asp:TextBox ID="repartiTextBox" runat="server" Text='<%# Bind("marche_pc") %>' Style="width: 70%;" />
                    </td>
                </tr>
            </EditItemTemplate>
            <EmptyDataTemplate>
            ...
            <table style="border: 0px solid green; width: 100%; margin-top: 20px;">
                <tr style="">
                    <td style="width: 100%;">
                        <asp:TextBox ID="repartiTextBox" placeholder='<%# globals.ResourceHelper.GetString("String331") %>' runat="server" Text='<%# Bind("marche_pc") %>' Style="width: 100%; background-color: #a6ffa6; border: 1px solid black; box-sizing: border-box;" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 100%">
        ...
        <asp:SqlDataSource ID="MarchepcDataSource" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\itstdb.mdf;Integrated Security=True" DeleteCommand="DELETE FROM [marchepc] WHERE [Id] = @Id" InsertCommand="INSERT INTO [marchepc] ([marche_pc]) VALUES (@marche_pc)" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [marchepc]" UpdateCommand="UPDATE [marchepc] SET [marche_pc] = @marche_pc WHERE [Id] = @Id">
            <DeleteParameters>
                <asp:Parameter Name="Id" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
                <asp:Parameter Name="marche_pc" Type="String" />
            </InsertParameters>
            <UpdateParameters>
                <asp:Parameter Name="marche_pc" Type="String" />
            </UpdateParameters>
