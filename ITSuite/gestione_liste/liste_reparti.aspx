...
<%@ Page Language="VB" MasterPageFile="../MasterPage.master" AutoEventWireup="false" CodeFile="liste_reparti.aspx.vb" Inherits="gestione_liste_liste_reparti" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" Runat="Server">
    <%= globals.ResourceHelper.GetString("String346") %>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderSubTitle" Runat="Server">
    <%= globals.ResourceHelper.GetString("String347") %>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderCentral" runat="Server">
    <form id="form1" runat="server">
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="ID" DataSourceID="repartiDataSource" InsertItemPosition="LastItem" OnItemInserting="ListView1_ItemInserting">
            <AlternatingItemTemplate>
                <tr class="tr-alt-list">
                    ...
                    <td>
                        <asp:Label ID="repartiLabel" runat="server" Text='<%# Eval("reparti_presidio") %>' />
                    </td>
                </tr>
            </AlternatingItemTemplate>
            <EditItemTemplate>
                <tr class="tr-list-edit">
                    ...
                    <td>
                        <asp:TextBox ID="repartiTextBox" runat="server" Text='<%# Bind("reparti_presidio") %>' Style="width: 70%;" />
                    </td>
                </tr>
            </EditItemTemplate>
            <EmptyDataTemplate>
            ...
            <table style="border: 0px solid green; width: 100%; margin-top: 20px;">
                <tr style="">
                    <td style="width: 100%;">
                        <asp:TextBox ID="repartiTextBox" placeholder='<%# globals.ResourceHelper.GetString("String348") %>' runat="server" Text='<%# Bind("reparti_presidio") %>' Style="width: 100%; background-color: #a6ffa6; border: 1px solid black; box-sizing: border-box;" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 100%">
        ...
        <asp:SqlDataSource ID="repartiDataSource" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\itstdb.mdf;Integrated Security=True" DeleteCommand="DELETE FROM [listareparti] WHERE [Id] = @original_Id" InsertCommand="INSERT INTO [listareparti] ([reparti_presidio]) VALUES (@reparti_presidio)" OldValuesParameterFormatString="original_{0}" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [listareparti]" UpdateCommand="UPDATE [listareparti] SET [reparti_presidio] = @reparti_presidio WHERE [Id] = @original_Id">
            <DeleteParameters>
                <asp:Parameter Name="original_Id" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
                <asp:Parameter Name="reparti_presidio" Type="String" />
            </InsertParameters>
            <UpdateParameters>
                <asp:Parameter Name="reparti_presidio" Type="String" />
            </UpdateParameters>
