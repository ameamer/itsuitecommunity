...
<%@ Page Language="VB" MasterPageFile="../MasterPage.master" AutoEventWireup="false" CodeFile="liste_statimonitor.aspx.vb" Inherits="gestione_liste_liste_statimonitor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" Runat="Server">
       <%= globals.ResourceHelper.GetString("String352") %>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderSubTitle" Runat="Server">
       <%= globals.ResourceHelper.GetString("String353") %>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolderCentral" runat="Server">
    <form id="form1" runat="server">
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="ID" DataSourceID="StatimonitorDataSource" InsertItemPosition="LastItem" OnItemInserting="ListView1_ItemInserting">
            <AlternatingItemTemplate>
                <tr class="tr-alt-list">
                    ...
                    <td>
                        <asp:Label ID="repartiLabel" runat="server" Text='<%# Eval("stati_monitor") %>' />
                    </td>
                </tr>
            </AlternatingItemTemplate>
            <EditItemTemplate>
                <tr class="tr-list-edit">
                    ...
                    <td>
                        <asp:TextBox ID="repartiTextBox" runat="server" Text='<%# Bind("stati_monitor") %>' Style="width: 70%;" />
                    </td>
                </tr>
            </EditItemTemplate>
            <EmptyDataTemplate>
            ...
            <table style="border: 0px solid green; width: 100%; margin-top: 20px;">
                <tr style="">
                    <td style="width: 100%;">
                        <asp:TextBox ID="repartiTextBox" placeholder='<%# globals.ResourceHelper.GetString("String354") %>' runat="server" Text='<%# Bind("stati_monitor") %>' Style="width: 100%; background-color: #a6ffa6; border: 1px solid black; box-sizing: border-box;" />
                    </td>
                </tr>
                <tr>
                    <td style="width: 100%">
        ...
        <asp:SqlDataSource ID="StatimonitorDataSource" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\itstdb.mdf;Integrated Security=True" DeleteCommand="DELETE FROM [statimonitor_tab] WHERE [Id] = @Id" InsertCommand="INSERT INTO [statimonitor_tab] ([stati_monitor]) VALUES (@stati_monitor)" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [statimonitor_tab]" UpdateCommand="UPDATE [statimonitor_tab] SET [stati_monitor] = @stati_monitor WHERE [Id] = @Id">
            <DeleteParameters>
                <asp:Parameter Name="Id" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
                <asp:Parameter Name="stati_monitor" Type="String" />
            </InsertParameters>
            <UpdateParameters>
                <asp:Parameter Name="stati_monitor" Type="String" />
            </UpdateParameters>
