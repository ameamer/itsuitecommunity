<%@ Page Language="VB"  Title="Report stampanti | ITSuite by Ame Amer (admin@ameamer.com)" AutoEventWireup="false" CodeFile="report_stampanti.aspx.vb" Inherits="gestione_stampanti_report_stampanti" %>
...
<body>
    ...
    <div>
     <div class="report-page-title">
                <%=globals.ResourceHelper.GetString("String443") %> <%=DateTime.Now()%>&nbsp;-&nbsp;ITSuite by Ame Amer
            </div>
