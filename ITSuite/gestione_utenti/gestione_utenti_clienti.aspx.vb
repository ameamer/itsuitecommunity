...
Partial Class gestione_utenti_gestione_utenti_clienti
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        Me.Title = globals.ResourceHelper.GetString("String456") & " | ITSuite by Ame Amer (admin@ameamer.com)"
        ...
        UserSqlSource.SelectCommand = ITSuite_Database.DBConnectionStrings.SQLCommands.SQLCustomerListCommand()
