...
<%@ Page Language="VB" AspCompat="true" MasterPageFile="../MasterPage.master" AutoEventWireup="false" CodeFile="gestione_utenti_home.aspx.vb" Inherits="gestione_utenti_gestione_utenti_home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderTitle" Runat="Server">
 <div class="HorizontalTopMenuContainer">
        <div class="HorizontalTopMenuItemSelected" style="border-left: 1px solid lightgray;" >
            <%=globals.ResourceHelper.GetString("String457")%>
        </div>
        ...
        <div class="HorizontalTopMenuItemNotSelected" onclick="location.href='../gestione_utenti/gestione_utenti_clienti.aspx'">
            <a href="../gestione_utenti/gestione_utenti_clienti.aspx" title="Clienti"><%=globals.ResourceHelper.GetString("String459")%></a>
        </div>
    </div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderSubTitle" Runat="Server">
    <%=globals.ResourceHelper.GetString("String461")%>
</asp:Content>
