...
Partial Class gestione_utenti_gestione_utenti_home
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        Me.Title = globals.ResourceHelper.GetString("String95") & " | ITSuite by Ame Amer (admin@ameamer.com)"
        ...
        UserSqlSource.SelectCommand = ITSuite_Database.DBConnectionStrings.SQLCommands.SQLUserListCommand()
    ...
    Protected Sub DataPager1_Init(sender As Object, e As EventArgs)
        ...
        pg.PageSize = CUInt(Session("risultati_pag"))
    End Sub
